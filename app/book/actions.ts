...
function buildUserConfirmation(opts: {
  ...
  if (lang === "zh") {
    ...
    const lines = [
      ...
      "• 我们如何携手合作:https://baamreview.com/zh#partnership",
      "• 《合作方式说明》PDF:https://baamreview.com/BAAM-Review-合作方式说明.pdf",
      "",
      "如有补充信息,直接回复本邮件即可。",
      "",
      "期待与您交流,",
  ...
  const lines = [
    ...
    "• How we work together: https://baamreview.com/#partnership",
    "• Download the partner guide (PDF): https://baamreview.com/BAAM-Review-How-We-Work-Together.pdf",
    "",
