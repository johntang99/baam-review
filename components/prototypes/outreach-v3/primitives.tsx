...
import type { StatusTone, V3Metric } from "@/components/prototypes/outreach-v3/types";
...
export function V3MetricGrid({ metrics }: { metrics: V3Metric[] }) {
  return (
    <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
      {metrics.map((metric) => (
        <article key={metric.label} className="rounded-xl border border-slate-200 bg-white p-3">
