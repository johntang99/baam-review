...
import { V3TopChip, V3StatusBadge } from "@/components/prototypes/outreach-v3/primitives";
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <div className="grid min-h-screen xl:grid-cols-[250px_1fr]">
        <aside className="flex flex-col gap-4 border-b border-slate-200 bg-slate-950 px-3 py-4 text-slate-100 xl:border-b-0 xl:border-r">
          ...
          <section className="rounded-lg border border-slate-800 bg-slate-900/70 px-3 py-2">
            <p className="text-sm font-semibold text-slate-100">Natural Life Acupuncture</p>
            <p className="mt-0.5 text-[11px] text-slate-400">Growth Plan - 4 seats - NYC</p>
          </section>

          <nav className="grid gap-1">
            <p className="px-2 text-[10px] uppercase tracking-[0.1em] text-slate-500">Workspace</p>
          ...
          <section className="mt-auto grid gap-2">
            <p className="px-2 text-[10px] uppercase tracking-[0.1em] text-slate-500">Safety</p>
          ...
          <header className="border-b border-slate-200 bg-white px-4 py-3 sm:px-5">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-2 text-xs text-slate-500">
                <span>Workspace</span>
                <span>/</span>
                <strong className="font-semibold text-slate-700">Natural Life Acupuncture</strong>
                <span>/</span>
