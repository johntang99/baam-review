...
const SINGLE_SEND_CHECKS = [
  ...
  { title: "Cadence window", subtitle: "Interval policy respected", tone: "good", label: "Pass" },
  { title: "Template risk", subtitle: "No spam trigger phrases", tone: "good", label: "Pass" },
  {
      ...
      <section className="grid gap-3 xl:grid-cols-[1.4fr_1fr]">
        <V3Panel className="space-y-3">
          ...
          <label className="grid gap-1">
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Subject</span>
            <span className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700">
          ...
          <label className="grid gap-1">
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-slate-500">Body</span>
        ...
        <V3Panel className="space-y-3">
          ...
          <div className="space-y-2 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs text-slate-600">
            <p>
              <strong className="text-slate-800">Preview sender:</strong> support@baamplatform.com
            </p>
            <p>
              <strong className="text-slate-800">Tracking:</strong> Open tracking on, unsubscribe token on
            </p>
            <p>
              <strong className="text-slate-800">Final action:</strong> Opens Gmail compose with fields prefilled
            </p>
          </div>
        </V3Panel>
      </section>
