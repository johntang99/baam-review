...
const PAGE_2_BUSINESSES: InputBusiness[] = [
  { rank: 21, name: "AestheticsMD by Jean Rhee Upper East Side", address: "673 Madison Ave 2nd Floor, New York, NY" },
  { rank: 22, name: "Hills Barber Shop", address: "72-23 Austin St, Forest Hills, NY 11375" },
  { rank: 23, name: "Hairrari Barber East Village", address: "34 E 1st St, New York, NY 10003" },
  { rank: 24, name: "AestheticsMD by Jean Rhee Flushing Koreatown", address: "157-02 Northern Blvd, Flushing, NY 11354" },
  { rank: 25, name: "Bowery Day Spa", address: "86 Bowery 1st Floor, New York, NY 10013" },
  { rank: 26, name: "Real KungFu Little Steamed Buns Ramen", address: "811 8th Ave, New York, NY 10019" },
  { rank: 27, name: "TLC Laser Eye Centers", address: "437 5th Ave Second Floor, New York, NY" },
  { rank: 28, name: "Korea Taekwondo - KTKD Flushing", address: "130-30 31st Ave, Flushing, NY 11354" },
  { rank: 29, name: "Victoria's Esthetics", address: "92-22 Corona Ave., Queens, NY 11373" },
  { rank: 30, name: "Dr. Lanna Aesthetics", address: "140 W 58th St Suite A, New York, NY" },
  { rank: 31, name: "Si Seung Hee Hair Salon", address: "149-48 41st Ave, Flushing, NY 11355" },
  { rank: 32, name: "Royal Beauty Studio", address: "107-29 71st Ave, Forest Hills, NY 11375" },
  { rank: 33, name: "MG Hair Artistic Salon - Manhattan", address: "20 St Marks Pl, New York, NY 10003" },
  { rank: 34, name: "La Vita Skincare & Laser", address: "5906 7th Ave, Brooklyn, NY 11220" },
  {
    rank: 35,
    name: "Lash n Brow by KT | Eyelash Extensions | Permanent Makeup | Lash Lift | Brow Lamination | Academy",
    address: "4 Ct Square W #3fl, Long Island City, NY",
  },
  { rank: 36, name: "Salon V", address: "10 E 8th St, New York, NY 10003" },
  { rank: 37, name: "Estelle Hair Studio", address: "68-60 Austin St #7, Forest Hills, NY" },
  { rank: 38, name: "Fox and Jane", address: "277 E 10th St, New York, NY 10009" },
  { rank: 39, name: "Alex Barber & salon", address: "85-23 Whitney Ave, Elmhurst, NY 11373" },
  { rank: 40, name: "Posh Hair Studio", address: "81-01 Lefferts Blvd, Kew Gardens, NY" },
];
...
async function main() {
  ...
  for (const business of PAGE_2_BUSINESSES) {
    try {
  ...
  console.log("=== Beauty & Wellness Page 2 · System vs LLM ===");
  console.log(`Businesses requested: ${PAGE_2_BUSINESSES.length}`);
...
main().catch((err) => {
  console.error("[compare-beauty-wellness-page2] failed:", err);
  process.exitCode = 1;
});
